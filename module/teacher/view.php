                             ...
                             if (mysqli_num_rows($result) > 0) {
                                 ...
                                 while ($row = mysqli_fetch_assoc($result)) {
                                    echo '<tr>
                                        ...
                                        <td>
                                            <a href="?m=teachers&s=edit&id='.$row['id'].'" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                            <a href="?m=teachers&s=delete&id='.$row['id'].'" onclick="return confirm(\'Yakin akan dihapus?\')" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>';
                                    $no++;
                                 }
